...
export default function Quill() {
  ...
  return (
    <div className="flex flex-col items-center relative justify-center rounded-xl m-4 pt-4 px-4 bg-gradient-to-r from-opacity-60 from-[#303238] via-opacity-10 via-[#696969] to-opacity-60 to-[#3a3a3a] w-4/5 lg:w-[1000px]">
      <ReactQuill
        theme="snow"
        value={value}
        modules={modules}
        onChange={setValue}
        className="bg-[#212226] border rounded-lg h-launch min-h-launch w-full z-10"
      />
      <div className="launcher-bottom mt-1.5">
        <div className="flex flex-grow items-center mb-2">
          <svg
            viewBox="0 0 15 15"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="mr-1.5 w-9 h-9"
          >
            <path
        ...
        <div className="flex flex-grow text-right w-[73px] items-center justify-end">
          <div className="relative p-[2px] rounded-md cursor-pointer bg-gradient-to-t from-hsla-[0,0%,100%,0.17] via-transparent to-hsla-[0,0%,100%,0.03] bg-gradient-conic-115.52 before:pointer-events-none before:select-none before:absolute before:opacity-100 before:transition-opacity before:duration-400 before:ease before:bg-radial-gradient-hsla-[0,0%,100%,0.3]-transparent-30 bg-[25rem] bg-[at-center-x-center-y]">
            <div className="rounded-lg border border-[#6969692c] pointer-events-none select-none absolute z-10 inset-0 transition-opacity duration-400 ease bg-gradient-to-t from-hsla-[0,0%,100%,0.17] via-transparent to-hsla-[0,0%,100%,0.05] bg-gradient-conic-115.52"></div>
